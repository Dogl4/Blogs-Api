...
| [<img alt="Screenshot da API" height="420em" width="auto" src="./images/blogApi.gif">](./images/blogApi.gif "Screenshot da API") |
|--------------------------------------------------------------------------------------------------------------------------------|
...
<details>
 ...
 | [<img alt="Screenshot da cobertura de test" height="540em" width="auto" src="./images/testCov.png">](./images/testCov.png "Cobertura de testes")   |
 |--------------------------------------------------------------------------------------------------------------------------------------------------|
